...
- [Check code — Vérifications sur PR](https://claude.ai/chat/536db79a-5ad1-4cc0-9332-d6edbdf0b476#-check-code--v%C3%A9rifications-sur-pull-request)
- [Déploiement DEV](https://claude.ai/chat/536db79a-5ad1-4cc0-9332-d6edbdf0b476#-d%C3%A9ploiement-dev-test_factory)
...
```mermaid
flowchart LR
    A[Checkout code] --> B[Config SSH]
    B --> C[rsync → VPS]
    C --> D[docker compose up -d --build]
    D --> E[Nettoyage clé SSH]
```
